  ...
  define(
    ...
    function (ko, $, ArrayDataProvider, HtmlUtils, ResponsiveUtils, ResponsiveKnockoutUtils) {
    ...
    function DashboardViewModel() {
      ...
      var url = "blankapp/src/js/store_data.json";  //defines link to local data file

      // Get Activity objects from file using jQuery method and a method to return a Promise
      $.getJSON("js/store_data.json").then(function (data) {
          ...
          // Create variable for Items list and populate using key attribute fetch
